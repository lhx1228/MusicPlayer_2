...
def Input_songName():
    ...
    listBox= tkinter.Listbox(frame,selectmode=tkinter.BROWSE,width=30,height=30,bg="#FFFFFF",listvariable=lv)  
    listBox.pack()
    e1 = Entry(frame,bg='#FFFFFF')
    #e1.grid()
    e1.place(x=50,y=150)
    songName = e1.get()
    tkinter.Label(master, text="搜索",fg='#000000',bg="#FFFFFF").place(x=10,y=148)
